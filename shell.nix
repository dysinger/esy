...
let
  ...
  esy = pkgs.callPackage (pkgs.callPackage ./nix/esy {}) {};
  ...
  esy-with-tools-fhs =
    pkgs.buildFHSUserEnv {
      ...
      targetPkgs = pkgs: with pkgs; [
        binutils cacert curl esy gnumake m4 patch perl stdenv.cc which
      ];
      ...
      runScript = "env SSL_CERT_FILE=/etc/ssl/certs/ca-bundle.crt bash";
    };

in esy-with-tools-fhs.env
